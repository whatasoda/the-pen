...
## 制作物
スマートフォンのモーションセンサーを用いたデジタル楽器アプリケーションを制作している。自分の持っている技術の傾向から、これをWebサイトとして開発する。
...
## UIについて
提出時点でのUIは仮のもので、今後展示に向けてアップデートを進めていく。音が出る模様の部分一つひとつを恒星系に見立てて、正面に来たときには惑星の回転が速くなったりするようなものを今後の展望として考えている。
